...
def itemc():
    ...
    parser = argparse.ArgumentParser(
        description='generate code for the item model.')
    parser.add_argument(
        'model_files', metavar='model_files', type=str, nargs='+',
        help='model filenames')
    parser.add_argument(
        '--src-gen-folder', dest='srcgen', default="src-gen", type=str,
        help='folder where to generate the code')
    parser.add_argument(
        '--generate-cpp', dest='generate_cpp', default=False,
        action='store_true', help='generate C++ code')
    parser.add_argument(
        '--generate-python', dest='generate_python', default=False,
        action='store_true', help='generate python code')
    parser.add_argument(
        '--generate-octave', dest='generate_octave', default=False,
